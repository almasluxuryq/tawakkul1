...
export const translations = {
  ru: {
    ...
    manifesto: {
      label: 'Наш манифест',
      heading: 'TAWAKKUL — это про',
      headingItalic: 'упование.',
      paragraph1: 'TAWAKKUL — это про Упование. Мы верим, что истинный Таваккуль — это не ждать сложа руки, а делать всё возможное и затем полностью полагаться на Аллаха. Именно эта идея лежит в основе нашего бренда. Каждая вещь напоминает не только о стиле, но и о внутреннем состоянии человека.',
      paragraph2: 'Каждая деталь создаётся с намерением. От выбора материалов до последнего стежка — всё отражает наши ценности. TAWAKKUL — это не просто одежда. Это ежедневное напоминание жить с упованием, действием и искренним намерением.',
      cards: {
        religion: {
          title: 'Одна религия',
